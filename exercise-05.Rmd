...
**INCOMPLETE Step 6**
Here, I'm sampling one subset of 50 zombie apocalypse survivors (without replacement) from this population and calculatinng the mean and sample standard deviation for each variable.
```{r}
